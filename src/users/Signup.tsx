...
function Signup({ signup }: SignupProps) {
    ...
    return (
        <div id="Signup" className="mx-8 my-8 bg-base-200 rounded-xl shadow-lg">
            <form
                id="Signup-form"
                className="flex flex-wrap lg:flex-nowrap justify-center gap-8 p-8"
                onSubmit={handleSubmit}>
                <label
                    className="input input-lg input-bordered bg-[#F0F3F5]
                    text-[#160C28] flex items-center
                    gap-2 w-full lg:w-1/4">
